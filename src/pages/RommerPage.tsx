...
const plans = [
  {
    ...
    price: "R$ 19,97",
    description: "Ideal para quem quer experimentar o Roma Nexus e descobrir todo o seu potencial.",
  },
  {
    name: "Plano Quinzenal",
    price: "R$ 29,97",
    description: "Perfeito para quem precisa de flexibilidade com renovação a cada quinze dias.",
  },
  {
    name: "Plano Mensal",
    price: "R$ 39,97",
    description: "A melhor escolha para uso contínuo com todos os recursos disponíveis por um mês inteiro.",
  },
];

// TODO: Substitua pela URL real do gateway de pagamento
const GATEWAY_URL = "https://SEU-GATEWAY-AQUI.com";
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <ScrollReveal delay={100}>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl mb-10">
              O Roma Nexus reúne CRM, automação de mensagens e inteligência artificial num único software.
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {plans.map((plan, i) => (
              <ScrollReveal key={plan.name} delay={i * 100}>
                <div className="bg-background rounded-lg p-8 card-shadow h-full flex flex-col hover:card-shadow-hover transition-shadow duration-300">
                  <h3
                  ...
                  <p className="text-3xl font-bold text-accent mb-4">{plan.price}</p>
